...
training_config = configs.Baichuan2PartialTrainingConfig()
logger_config = configs.LoggerConfig(level='DEBUG')
path_config = configs.PathConfig()
other_config = configs.OtherConfig(device='auto')

logger = Logger('baichuan2_partial_eval_by_emb', logger_config.level, logger_config.path)
...
embeddings_saving_path = path_config.models / 'baichuan2_pertial_eval_by_emb.pt'
